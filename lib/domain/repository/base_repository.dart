...
abstract class BaseRepository {
  Future<Either<Failure, List<AirportDTO>>> getNearbyAirports(double lat, double lng,int radius);
  Future<Either<Failure, AirportDetailsDTO>> getAirportByCode(String code);

  Future<Either<Failure, List<AirportDTO>>> deleteAirportFromBookmark(AirportDTO airportDTO);
  Future<Either<Failure, AirportDTO>> addAirportToBookmark(AirportDTO airportDTO);
